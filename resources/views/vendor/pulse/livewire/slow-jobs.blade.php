<x-pulse::card :cols="$cols" :rows="$rows" :class="$class">
    ...
    >
        ...
        <x-slot:actions>
            ...
            @php
                $appOptions = $slowJobs->pluck('app_name')->filter()->unique()->sort();
        ...
        @else
            <x-pulse::table>
                ...
                <tbody>
                    ...
                    @foreach ($slowJobs->take(100)->filter(fn($query) => empty($appName) || $query->app_name === $appName)->take(100)  as $job)
