...
use Illuminate\Support\Facades\Gate as GateFacades;
...
class PulseServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        $this->mergeConfigFrom(
            ...
            // base_path('modified-vendor/Pulse/config/pulse-modified.php'), 'pulse'
        );
    ...
    public function boot(): void
    {
        ...
        $this->registerRoutes();     // tutup di aplikasi yang dimonitoring
        $this->registerComponents();
        $this->registerResources(); // tutup di aplikasi yang dimonitoring
    ...
    protected function registerComponents(): void
    {
        $this->callAfterResolving('blade.compiler', function (BladeCompiler $blade) {
            ...
            // $blade->anonymousComponentPath(base_path('modified-vendor/Pulse/resources/views/components'), 'pulse');
        });
        // dd('tes');
    ...
    protected function registerResources(): void
    {
        ...
        // $this->loadViewsFrom(base_path('modified-vendor/Pulse/resources/views'), 'pulse');
    }
